...
// @panux-ui/react's own compiled recipe CSS (Box/Center/Container/Stack/
...
import '@panux-ui/react/styles.css';
 ...
 * Phase 4 gap, not an oversight: `ThemeProvider`/`useTheme` (@panux-ui/react)
 * themes the actual component examples via `--panux-*` tokens;
